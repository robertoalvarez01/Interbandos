<?php 
	...
	$pamarillo = $inicioam - $pamarillo;
	$pazul = $inicioaz - $pazul;
	$pblanco = $iniciobl - $pblanco;
		...
		<div class="container">
			<h1>Interbandos</h1>
				...
				<div class="col-md-12">
					...
					<a href="restar_datos.php"><button class="btn btn-lg btn-block btn-primary">Volver</button></a>
					<br>
