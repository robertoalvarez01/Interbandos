...
<body>
	...
	<center><h2>Sumar puntos</h2></center>
	<div class="container">	
		<form class="form-horizontal" action="sumar.php" method="POST" autocomplete="off">
			  <div class="form-group">
			    <label for="indicador_puntos"><h2>Puntos azul:</h2></label>
			    <input type="text" class="form-control" name="pazul" id="indicador_puntos" placeholder="Ingresa los puntos a sumar">
			    <p>Los puntos del azul hasta el momento son: <?php echo $filaaz['puntos']; ?></p>
			  </div>
			  <div class="form-group">
			    <label for="indicador_puntos"><h2>Puntos blanco:</h2></label>
			    <input type="text" class="form-control" name="pblanco" id="indicador_puntos" placeholder="Ingresa los puntos a sumar">
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control" name="pamarillo" id="indicador_puntos" placeholder="Ingresa los puntos a sumar">
			    <p>Los puntos del amarillo hasta el momento son: <?php echo $filaam['puntos']; ?></p>
			  </div>
			  <div class="form-group">
			    <button type="submit" class="btn btn-primary">Enviar</button>
			  </div>
			  <a href="restar_datos.php">Restar puntos</a>
	  	</form>
	</div>
